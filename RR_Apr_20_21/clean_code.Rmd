...
R: 
x=1:100; #Create a vector 'x' of length 100 
y=1:100; #Create a vector 'y' of length 100
y[3*x]='Fizz'; #Replace number with word 'Fizz' in vector 'y' at every interval/multiple of 3
y[5*x]='Buzz'; #Substitute/Replace number with word 'Buzz' in Vector 'y' at every interval/multiple of 5
y[15*x]='FizzBuzz'; #Substitute/Replace number with word 'FizzBuzz' in Vector 'y' at every interval/multiple of 15
write(y[x],1) #Print vector y till the length of vector x
...
# take input from the user to show the number of rows
nrows = as.integer(readline(prompt="How many rows you want to display? "))
# first two rows
n1 = 0
n2 = 1
count <= 1
...
rev_num = 0;
  for (num in rev_num) {
    rev_num = (rev_num*10)+ #Append lastDigit to reverse
    (num%10) #Isolate the last digit in number
    rev_num = num/10 #Remove last digit from number
